...
class BackupDataController extends Controller
{
    ...
    public function eksport(){
        ...
        ->select('no_register','pekerjaan_investors.investor_id','nm_investor','jenis_rekening','profil_resiko_nasabah','staf_pemasaran_id','jenis_kelamin',
