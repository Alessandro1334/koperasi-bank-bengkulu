@can('isOperator')
    ...
    <li class="treeview {{ set_active(['operator.form_pembukaan_rekening','operator.tambah_investor','operator.manajemen_saham','operator.tambah_saham']) }}">
        <a href="#">
        ...
        <ul class="treeview-menu ">
            ...
            <li class="{{ set_active(['operator.manajemen_saham','operator.tambah_saham']) }}"><a href="{{ route('operator.manajemen_saham') }}"><i class="fa fa-circle-o"></i>Pembelian/Pengalihan Saham</a></li>
            {{-- <li class=""><a href="{{ route('operator.verifikasi_data_investor') }}"><i class="fa fa-circle-o"></i>Data Agen Penjualan Aktif</a></li> --}}
        </ul>
    </li>

    <li class="treeview {{ set_active(['operator.pembukaan_rekening_institusi','operator.tambah_institusi','operator.tambah_saham_institusi','operator.pembelian_saham_institusi']) }}">
        <a href="#">
        ...
        <ul class="treeview-menu ">
            <li class="{{ set_active(['operator.pembukaan_rekening_institusi','operator.tambah_institusi']) }}"><a href="{{ route('operator.pembukaan_rekening_institusi') }}"><i class="fa fa-wpforms"></i>Form Pembukaan Rekening</a></li>
    ...
    <li class="header" style="font-weight:bold;">KELUAR</li>
    <li class="">
