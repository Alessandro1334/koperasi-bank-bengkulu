        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-bar-chart"></i>&nbsp;Laporan Data Nasabah/Investor Non Perorangan</h3>

                </div>
                <!-- /.box-header -->
                <div class="box-body table-responsive">
                    <div class="row" style="margin-bottom:10px;">
                        <form action="{{ route('manajer.laporan_institusi_filter') }}" method="GET">
                    ...
                    <table class="table table-bordered table-hover" id="laporan_nasabah">
                        <thead>
                            <tr>
                                ...
                                <th>Nama Perusahan/Institusi</th>
                                <th>No. CIF</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($nasabahs as $nasabah)
                                <tr>
                                    ...
                                    <td>{{ $nasabah->nm_institusi }}</td>
                                    <td>{{ $nasabah->no_cif }}</td>
                                    <td>{{ $nasabah->tipe_perusahaan }}</td>
                                    <td>{{ $nasabah->karakteristik }}</td>
