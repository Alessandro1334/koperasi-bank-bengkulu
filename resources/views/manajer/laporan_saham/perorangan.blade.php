...
@section('location2')
    <i class="fa fa-bar-chart"></i>&nbsp;Laporan Saham Perorangan
@endsection
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-user"></i>&nbsp;Laporan Saham Nasabah\Investor Perorangan</h3>
                </div>
                ...
                <div class="box-body table-responsive">
                    ...
                    <form role="form" method="POST" action="{{ route('manajer.laporan_perorangan_import') }}">
                        {{ csrf_field() }}
