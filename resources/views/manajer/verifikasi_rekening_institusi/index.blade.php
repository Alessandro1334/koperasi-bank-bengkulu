        ...
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="b" table-responsive>
                        <table class="table table-bordered table-hover saham" >
                            <thead>
                                <tr>
                                    <th>No</th>
    ...
    <script>
        ...
        function verifikasi(id){
            ...
            success: function(data){
                ...
                $('#sk3s_lama').val(data.no_sk3s_lama);
            },
            error:function(){
                alert("Nothing Data");
            }
        ...
        $('.saham').on('click','.detail',function() {
            var id_saham = $(this).data("id_saham");
            var institusi_id = $(this).data("institusi_id");
            $.ajax({
                url: "{{ url('manajer/verifikasi_rekening_institusi/detail') }}",
                type: "GET",
                data: {
                    id_saham : id_saham,
